    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MaterialTheme {
                ...
                LaunchedEffect(playing, cursor.totalFrames) {
                    while (playing && cursor.totalFrames > 1) {
                        val next = min(cursor.cursorIndex + 25, cursor.totalFrames - 1)
                ...
                Surface(modifier = Modifier.fillMaxSize()) {
                    Column(
                        ...
                        Text("Version 2.5 - Interactive Replay Studio")
                            ...
                            onClick = {
                                scope.launch {
                                    ...
                                    val stats = withContext(Dispatchers.IO) {
                                        replay.loadMostRecent(maxFrames = 120000) { p -> replayProgress = p }
                                    }
